...
module.exports = {
  ...
  createGuest: function (params, callback) {
    ipcRendererUtils.invoke('ELECTRON_GUEST_VIEW_MANAGER_CREATE_GUEST', params).then(callback)
  },
  ...
  destroyGuest: function (guestInstanceId) {
    ipcRendererInternal.invoke('ELECTRON_GUEST_VIEW_MANAGER_DESTROY_GUEST', guestInstanceId)
  },
